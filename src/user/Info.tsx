...
export default function Info() {
    ...
    return (
        <div className={"flex flex-col"}>
            ...
            <a href={""} target="_blank" className={"bg-green-500 w-auto h-20 rounded-br-3xl flex items-center justify-center text-xl font-bold hover:text-white cursor-pointer mt-10"}>Lebenslauf
                herunterladen</a>
        </div>
    );
}