...
export default function CareerTab({
                                      ...
                                      isEditVisible,
                                      onSaveEditedCareer
                                  }: { career: TCareer, isEditVisible: boolean, onDelete: (id: string) => {}, onSaveEditedCareer: (career: GENERIC_DAO) => void }) {
        ...
        <div className={"flex flex-col careerTileWidth mt-5 mr-5"}>
            {isEditVisible &&
              <div className={"flex flex-row"}>
                ...
                <EditStepModal onSaveExp={onSaveEditedCareer} editExpObj={careerDt}
